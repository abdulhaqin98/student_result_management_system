...
function submitreq() {
    ...
    var ref = database.ref('revaluation/' + semester + '/' + 's001');
    ref.remove();

    internal_id.map((id, index) => {

        database.ref('revaluation/' + semester + '/' + rollnumber + '/internal').update({
    ...
    external_id.map((id, index) => {
        ...
        database.ref('revaluation/' + semester + '/' + rollnumber + '/external').update({
    ...
    practical_id.map((id, index) => {
        ...
        database.ref('revaluation/' + semester + '/' + rollnumber + '/practical').update({
    ...
    database.ref('revaluation/' + semester + '/' + rollnumber).update({
        date,
        pay : totalpay,
        paid : 'notpaid',
        status : 'notprocessed',
