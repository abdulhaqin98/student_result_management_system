...
function load_students() {
    ...
    var ref = database.ref('photocopy/' + semester_select + '/');
    ref.once("value")
...
function load_details(data) {
    ...
    var ref = database.ref('photocopy/' + semester_select + '/' + roll + '/');
    ref.once("value")
        .then(function (snapshot) {
...
function load_update(data) {
    ...
    firebase.database().ref('photocopy/' + semester_select + '/' + roll).update({
        paid,
        status
    });
